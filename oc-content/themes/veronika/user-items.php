            ...
            <div class="card item round3 tr1">
              ...
              <div class="stats">
                <?php
                  ...
                  $query = "SELECT sum(s.i_num_views) as views, sum(s.i_num_premium_views) as premium_views, sum(s.i_num_phone_clicks) as phone_clicks FROM {$db_prefix}t_item_stats s WHERE s.fk_i_item_id = " . osc_item_id() . ";";
              ...
              <div class="buttons">
                ...
                <?php } else { ?>
                  ...
                  <a class="sold round2 tr1" href="<?php echo osc_user_list_items_url() . $sold_url; ?>"><i class="fa fa-handshake-o"></i> <?php echo (osc_item_field('i_sold') == 1 ? __('Not sold', 'veronika') : __('Sold', 'veronika')); ?></a>
                  <a class="reserved round2 tr1" href="<?php echo osc_user_list_items_url() . $reserved_url; ?>"><i class="fa fa-flag-o"></i> <?php echo (osc_item_field('i_sold') == 2 ? __('Unreserve', 'veronika') : __('Reserve', 'veronika')); ?></a>
