        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <li>
                    ...
                    <div style="background: #fff url(<?php echo osc_current_web_theme_url() ; ?>/images/categorys/<?php echo osc_category_id() ; ?>.png) no-repeat;background-size:contain;background-position: center center;" class="icos <?php echo osc_category_slug() ; ?>"></div></a>
...
$(function(){
   ...
   $('.show-more').on('click', function(){
       $('.lia-list-standard li:gt(9)').show();
       $('.show-less').removeClass('hidden');
       $('.show-more').addClass('hidden');
    });

    $('.show-less').on('click', function(){
       $('.lia-list-standard li:gt(9)').hide();
       $('.show-more').removeClass('hidden');
       $('.show-less').addClass('hidden');
    });
    
    //Show only four items
    if ( $('.lia-list-standard li').length > 10 ) {
        /*$('.lia-list-standard li:gt(9)').hide();
        $('.show-more').removeClass('hidden');
        */
