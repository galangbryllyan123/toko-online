<?php
    ...
    udhauli_add_body_class('recover');
    osc_current_web_theme_path('header.php');
?>
<div class="form-row-header"> 
    <h1 id="form-row-h1"><?php _e('Recover your password', 'udhauli'); ?></h1>
</div> 
   ...
   <div class="col-md-6 col-md-offset-3 item-post" id="form-login">
      <div class="form-login">
        ...
        <div class="control-group">
            ...
            <div class="control-group">
                <div class="controls">
                    <button type="submit" class="btn btn-md"><?php _e("Send me a new password", 'udhauli');?></button>
                </div>
            </div><br><br>
        </form>
    </div>
