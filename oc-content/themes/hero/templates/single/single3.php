...
<div class="ribbonse"><div class="banner">
                ...
                <div class="gambars"> <img id="zoom_03" alt="<?php echo osc_esc_html(osc_item_title()) ; ?>" src="<?php echo osc_resource_url(); ?>" data-zoom-image="<?php echo osc_resource_url(); ?>" />
                    <div id="gallery_01">
                        <?php for ( $i=0 ; osc_has_item_resources(); $i++ ) { ?> <a href="#" class="gallery_01 " data-image="<?php echo osc_resource_url(); ?>" data-zoom-image="<?php echo osc_resource_url(); ?>"><img alt="<?php echo osc_esc_html(osc_item_title()) ; ?>" src="<?php echo osc_resource_thumbnail_url(); ?>" /> </a>
                        <?php } ?> </div>
                </div>
                <?php } else { ?>
