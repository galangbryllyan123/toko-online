...
$random = rand(0, 15); //more info about the rand function can be found at the link below. ?>
    ...
    "category_name" => osc_get_preference('slidercatname2', 'wayst'),
	"results_per_page" => "16",
	// "offset" => $random
...
if( osc_count_custom_items() == 0) { ?>
    <h2 class="front-title">
                           <?php echo osc_get_preference('slidercatname2m', 'wayst'); ?>: <?php _e('No Listings', 'wayst') ; ?></h2>
<?php } else { ?>
    <h2 class="front-title">
                            <?php _e('Listings', 'wayst') ; ?>: <?php echo osc_get_preference('slidercatname2m', 'wayst'); ?>                        </h2>
            ...
            <a href="<?php echo osc_item_url(); ?>" class="<?php osc_run_hook("highlight_class"); ?> <?php echo $class. (osc_item_is_premium()?" premium":""); ?>" data-cat="Front" data-label="<?php echo osc_item_title(); ?>"></a>
