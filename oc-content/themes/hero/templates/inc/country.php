...
<form action="<?php echo osc_base_url(true); ?>" method="get" role="search" class="nocsrf">
    ...
    <fieldset>
        ...
        <div class="col-md-2">
            <div class="row">
                <div class="cell selector">
                    <?php hero_countries_select('sCountry', 'sCountry', __('Select a country', 'hero'));?> </div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="row">
                <div class="cell selector">
                    <?php hero_regions_select('sRegion', 'sRegion', __('Select a region', 'hero')) ; ?> </div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="row">
                <div class="cell selector">
                    <?php hero_cities_select('sCity', 'sCity', __('Select a city', 'hero')) ; ?> </div>
            </div>
        </div>
        <div class="col-md-2">
            <div class="row">
