...
$random = rand(0, 15); //more info about the rand function can be found at the link below. ?>
    ...
    "category_name" => osc_get_preference('slidercatname3', 'wayst'),
	"results_per_page" => "16",
	// "offset" => $random
...
if( osc_count_custom_items() == 0) { ?>
    <h2 class="front-title">
                                  <?php echo osc_get_preference('slidercatname3m', 'wayst'); ?>:  <?php _e('No Listings', 'wayst') ; ?>                </h2>
<?php } else { ?>
<h2 class="front-title">
                            <?php _e('Listings', 'wayst') ; ?>: <?php echo osc_get_preference('slidercatname3m', 'wayst'); ?>                        </h2>
