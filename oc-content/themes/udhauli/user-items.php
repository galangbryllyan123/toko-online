<?php
    ...
    udhauli_add_body_class('user user-items');
...
<div class="col-md-9" id="user-items-col">
<div class="list-header">
    <?php osc_run_hook('search_ads_listing_top'); ?>
    <h1><?php _e('My listings', 'udhauli'); ?></h1>
    <?php if(osc_count_items() == 0) { ?>
        <p class="empty" ><?php _e('No listings have been added yet', 'udhauli'); ?></p>
    <?php } else { ?>
        <div class="actions">
