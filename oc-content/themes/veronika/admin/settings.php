...
<div class="mb-body">
  <div class="mb-info-box" style="margin:5px 0 30px 0;">
    ...
    <div class="mb-line" style="margin:10px 0;"><a href="http://mb-themes.com/theme-plugins/veronika-plugins.zip" target="_blank" class="mb-button-white"><i class="fa fa-download"></i> <?php _e('Download plugins', 'veronika'); ?></a></div>
    ...
    <form action="<?php echo osc_admin_render_theme_url('oc-content/themes/' . osc_current_web_theme() . '/admin/settings.php'); ?>" method="post">
      ...
      <div class="mb-inside">
        <div class="mb-row">
          ...
          <input size="40" name="phone" id="phone" type="text" value="<?php echo osc_esc_html( osc_get_preference('phone', 'veronika_theme') ); ?>" placeholder="<?php _e('Contact number', 'veronika'); ?>" />
        ...
        <div class="mb-row">
          ...
          <input size="40" maxlength="12" name="logo_text" id="logo_text" type="text" value="<?php echo osc_esc_html( osc_get_preference('logo_text', 'veronika_theme') ); ?>" placeholder="<?php _e('Logo text', 'veronika'); ?>" />
        ...
        <div class="mb-row">
          ...
          <textarea class="mb-textarea mb-textarea-large" name="site_info" placeholder="<?php _e('Info about your site', 'veronika'); ?>"><?php echo osc_esc_html( osc_get_preference('site_info', 'veronika_theme') ); ?></textarea>
        ...
        <div class="mb-row">
          ...
          <input size="40" name="website_name" id="website_name" type="text" value="<?php echo osc_esc_html( osc_get_preference('website_name', 'veronika_theme') ); ?>" placeholder="<?php _e('Website Name', 'veronika'); ?>" />
        </div>
        ...
        <div class="mb-row">
          ...
          <div class="mb-explain"><?php _e('Link to MB-themes and Osclass will be shown in footer.', 'veronika'); ?></div>
        </div>
        ...
        <div class="mb-row">
          ...
          <input size="40" name="footer_email" id="footer_email" type="text" value="<?php echo osc_esc_html( osc_get_preference('footer_email', 'veronika_theme') ); ?>" placeholder="<?php _e('Contact email', 'veronika'); ?>" />
        </div>
  ...
  <div class="mb-box">
    ...
    <form action="<?php echo osc_admin_render_theme_url('oc-content/themes/' . osc_current_web_theme() . '/admin/settings.php'); ?>" method="post">
      ...
      <div class="mb-inside">
        ...
        <div class="mb-row">
          <label for="banner_home" class="h29"><span><?php _e('Home Page Banner Code', 'veronika'); ?></span></label> 
          <textarea class="mb-textarea mb-textarea-large" name="banner_home" placeholder="<?php _e('Will be shown at bottom of home page, recommended is responsive banner with width 1200px', 'veronika'); ?>"><?php echo stripslashes( osc_get_preference('banner_home', 'veronika_theme') ); ?></textarea>
        </div>
        
        <div class="mb-row">
          <label for="banner_search" class="h29"><span><?php _e('Search Page Banner Code', 'veronika'); ?></span></label> 
          <textarea class="mb-textarea mb-textarea-large" name="banner_search" placeholder="<?php _e('Will be shown in left sidebar on search page, recommended is responsive banner with width 270px', 'veronika'); ?>"><?php echo stripslashes( osc_get_preference('banner_search', 'veronika_theme') ); ?></textarea>
        </div>

        <div class="mb-row">
          <label for="banner_item" class="h29"><span><?php _e('Home Page Banner Code', 'veronika'); ?></span></label> 
          <textarea class="mb-textarea mb-textarea-large" name="banner_item" placeholder="<?php _e('Will be shown in right sidebar on item page, recommended is responsive banner with width 360px', 'veronika'); ?>"><?php echo stripslashes( osc_get_preference('banner_item', 'veronika_theme') ); ?></textarea>
        </div>
      </div>
      ...
      <div class="mb-inside">
        <div class="mb-table">
          <div class="mb-table-head">
            ...
            <div class="mb-col-1_1_2 mb-align-left fa-icon"><a href="http://fortawesome.github.io/Font-Awesome/icons/" target="_blank"><?php _e('Font-Awesome icon', 'veronika'); ?></a></div>
  ...
  <div class="mb-box" id="mb-help">
    ...
    <div class="mb-inside">
      ...
      <div class="mb-row mb-help"><span class="sup">(6)</span> <div class="h6"><?php _e('I want to help OSClass & MB themes by linking to <a href="http://osclass.org/" target="_blank">osclass.org</a> and <a href="http://www.mb-themes.com" target="_blank">MB-Themes.com</a> from my site', 'veronika'); ?></div></div>
      ...
      <div class="mb-row mb-help"><span class="sup">(29)</span> <div class="h29"><?php _e('Will be shown at bottom of home page / left sidebar on search page / right sidebar on item page, recommended is responsive banner.', 'veronika'); ?></div></div>
