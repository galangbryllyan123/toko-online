      ...
      <div id="flashmessage" >
        <p>
          <select name="amount" class="select-box-medium">
            ...
            <option value="">
            <?php _e('Custom', 'lhoshar'); ?>
            </option>
          </select>
          <input type="submit" class="btn btn-mini" name="submit" value="<?php echo osc_esc_html(__('Donate', 'lhoshar')); ?>">
        </p>
      </div>
    </form>
  </div>
...
<div id="tabs" class="wizards_tab wiz_main_tabs">
  <ul>
    <li><a href="#general"><?php _e('General','lhoshar');?></a></li>
    <li><a href="#theme-style"><?php _e('Theme Style','lhoshar');?></a></li>
    <li><a href="#templates"><?php _e('Templates','lhoshar');?></a></li>
    <li><a href="#logo"><?php _e('Header Logo','lhoshar');?></a></li>
    <li><a href="#favicon"><?php _e('Favicon','lhoshar');?></a></li>
    <li><a href="#banner"><?php _e('Banner','lhoshar');?></a></li>
    <li><a href="#slider"><?php _e('Image Slider','lhoshar');?></a></li>
    <li><a href="#category"><?php _e('Category Icons','lhoshar');?></a></li>
    <li><a href="#ads"><?php _e('Ads Management','lhoshar');?></a></li>
    <li><a href="#social"><?php _e('Social Links','lhoshar');?></a></li>    
    <li><a href="#documentation"><?php _e('Documentation','lhoshar');?></a></li>
  </ul>
  <div id="general">
    <h2 class="render-title">
      <?php _e('Theme settings', 'lhoshar'); ?>
    </h2>
    <form action="<?php echo osc_admin_render_theme_url('oc-content/themes/lhoshar/admin/settings.php'); ?>" method="post" class="nocsrf">
      ...
      <fieldset>
        <div class="form-horizontal">
            ...
            <div class="form-label">
              <?php _e('Footer message', 'lhoshar'); ?>
            </div>
            <div class="form-controls">
              <textarea style="height: 50px; width: 500px;" name="footer_message"><?php echo  (osc_get_preference('footer_message', 'lhoshar')) ; ?></textarea>
            </div>
          </div>
          <div class="form-row">
            <div class="form-label">
              <?php _e('Show lists as', 'lhoshar'); ?>
            </div>
            <div class="form-controls">
              <select name="defaultShowAs@all">
                <option value="gallery" <?php if((lhoshar_default_show_as()) == 'gallery'){ echo 'selected="selected"'; } ?>>
                <?php echo osc_esc_html(__('Grid','lhoshar')); ?>
                </option>
                <option value="list" <?php if((lhoshar_default_show_as()) == 'list'){ echo 'selected="selected"'; } ?>>
                <?php echo osc_esc_html(__('List','lhoshar')); ?>
                </option>
              </select>
            </div>
            <div class="form-row">
                <div class="form-label"><?php _e('To the Top', 'lhoshar'); ?></div>
                <div class="form-controls">
                <div class="form-label-checkbox">
                  <input type="checkbox" name="to_the_top" value="1" <?php echo (osc_esc_html( osc_get_preference('to_the_top', 'lhoshar') ) == "1")? "checked": ""; ?>>
                  <br>
                  <div class="help-box"><?php _e('Move to the top.', 'lhoshar'); ?></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="form-actions">
        <input type="submit" value="<?php echo osc_esc_html(__('Save changes', 'lhoshar')); ?>" class="btn btn-submit btn-success">
      </div>
    </form>
  </div>
  <div id="theme-style">
