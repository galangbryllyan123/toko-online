...
<head>
  ...
  <?php if(osc_images_enabled_at_items() && !modern_is_fineuploader() && osc_get_preference('image_upload', 'tatiana_theme') == 1){
...
<body>
  <?php $def_cat['fk_i_category_id'] = Params::getParam('sCategory'); ?>
  <?php $def_country['fk_c_country_code'] = Params::getParam('sCountry'); ?>
  <?php if(is_numeric(Params::getParam('sRegion'))) { $def_reg['fk_i_region_id'] = Params::getParam('sRegion'); } else {  $def_reg['s_region'] = Params::getParam('sRegion'); }?>
  <?php if(is_numeric(Params::getParam('sCity'))) { $def_city['fk_i_city_id'] = Params::getParam('sCity'); } else {  $def_city['s_city'] = Params::getParam('sCity'); }?>
      ...
      <div class="cat-block">
        ...
        <?php while ( osc_has_categories() ) { ?>
          <div class="single-cat round3" id="<?php echo osc_category_id();?>">
            <a href="#" title="<?php echo osc_category_description() ; ?>" alt="<?php echo osc_category_name() ; ?>" id="<?php echo osc_category_id();?>">
  ...
  <div class="content add_item">
    <h1><?php _e('Add new listing', 'tatiana'); ?></h1>
    ...
    <form name="item" action="<?php echo osc_base_url(true);?>" method="post" enctype="multipart/form-data">
      ...
      <div id="left">
        <div class="box general_info">
          <div class="row catshow">
            ...
            <?php ItemForm::category_select(null, $def_cat, __('Select a category', 'tatiana')); ?>
        ...
        <div class="box photos photoshow <?php if(osc_get_preference('image_upload', 'tatiana_theme') == 1) { echo 'drag_drop'; } ?>">
          ...
          <div class="item-tool-wrap item-tool-photo">
            <div class="item-tool-arrow"></div>
      ...
      <button type="submit" id="blue"><?php _e('Publish', 'tatiana'); ?></button>
      </fieldset>
    </form>
  </div>
