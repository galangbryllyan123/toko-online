...
<!-- initiate page content -->
        ...
        <ul class="nav nav-tabs">
            <li class="active"><a href="#register" data-toggle="tab"><?php _e("Create", 'wayst');?></a></li>
            <li><a href="#login" data-toggle="tab"><?php _e("Log in", 'wayst');?></a></li>
        </ul>
