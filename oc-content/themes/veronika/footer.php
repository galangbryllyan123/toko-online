    <?php
      ...
      $sQuery = __('Pencarian', 'veronika') . ' ' . osc_total_active_items() . ' ' .  __('listings', 'veronika');
    ?>
  </div>
</div>
...
<?php if(osc_is_search_page()) { ?>
  ...
  <?php if(osc_count_latest_searches() > 0) { ?>
    <div id="latest-search">
      <div class="inside">
        <span><?php _e('Pencarian terbaru', 'veronika'); ?>:</span>
...
<div id="footer-partner" class="not767">
  <div class="inside">
    <div id="partner">
      <div class="lead"><?php _e('Partner kami', 'veronika'); ?></div>
  ...
  <div class="inside">
    <div class="left">
      <div class="links">
        ...
        <span class="link-span contact"><a href="<?php echo osc_contact_url(); ?>"><?php _e('Kontak', 'veronika'); ?></a></span>
      </div>
      ...
      <div class="about">
        <span><a href="<?php echo osc_contact_url(); ?>"><?php _e('Kontak', 'veronika'); ?></a></span>

        <?php if(osc_get_preference('footer_email', 'veronika_theme') <> '') { ?>
          <span><?php _e('Email', 'veronika'); ?> <a href="mailto:<?php echo osc_esc_html(osc_get_preference('footer_email', 'veronika_theme')); ?>"><?php echo osc_get_preference('footer_email', 'veronika_theme'); ?></a></span>
        <?php } ?>

        <?php if(osc_get_preference('footer_link', 'veronika_theme')) { ?>
          <span class="powered"><?php _e('Powered by', 'veronika'); ?> <a href="http://www.401xd.com">401XD Group</a></span>
          <span class="created">Created by <a href="http://www.mycoding.net/">Mycoding</a></span>
        <?php } ?> 
    ...
    <div class="right">
      ...
      <div class="share">
        ...
        <div class="header"><?php _e('Bagikan', 'veronika'); ?></div>
        ...
        <span class="pinterest"><a href="https://pinterest.com/pin/create/button/?url=<?php echo osc_base_url(); ?>/oc-content/themes/' . osc_current_web_theme() . '/images/logo.jpg&media=<?php echo $share_url; ?>&description=" title="<?php echo osc_esc_html(__('Share us on Pinterest', 'veronika')); ?>" target="_blank"><i class="fa fa-pinterest"></i></a></span>
