        ...
        <div class="td photo <?php if(osc_count_premium_resources() > 1) { ?>more-photo<?php } ?>">
          <div class="photo-wrap">
            ...
            <?php if(osc_count_premium_resources() > 1) { ?>
              <img src="<?php echo osc_resource_thumbnail_url(); ?>" title="<?php echo osc_premium_title(); ?>" class="photo-level" />
            <?php } ?> 
          </div>                         
        </div>
        
        <div class="td text">
          <h3><a id="s_tit" href="<?php echo osc_premium_url(); ?>" title="<?php echo osc_premium_title(); ?>"><?php echo ucfirst( osc_highlight( strip_tags( osc_premium_title() ), 90 ) ); ?></a><div id="icon-link"></div><?php if( osc_price_enabled_at_items() ) { echo '<span id="zoznam_cena">' . osc_premium_formated_price() . '</span>';} ?></h3>
          <div class="clear"></div>
          ...
          <p id="zoznam_popis"><?php echo osc_highlight( strip_tags( osc_premium_description() ), 130, '<span id="zoznam_highlight" title="Searched word">', '</span>'  ); ?></p>
        </div>
      </div>
