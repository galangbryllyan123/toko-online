  ...
  <div id="listing" class="content list">
                  ...
                  <div class="wrap">
                    <div class="phone<?php if(!$mobile_found) { ?> no-number<?php } ?>">
                      <a href="#" class="phone-block" data-item-id="<?php echo osc_item_id(); ?>" data-item-user-id="<?php echo osc_item_user_id(); ?>">
                        ...
                        <span>
                          <?php 
                            if(strlen($mobile) >= 4 and $mobile <> __('No phone number', 'veronika')) {
                  ...
                  <?php while ( osc_has_item_comments() ) { ?>
                    <div class="comment-wrap <?php echo $class; ?>">
                      <div class="ins">
                        ...
                        <div class="comment">
                          <h4><span class="bold"><?php if(osc_comment_title() == '') { _e('Review', 'veronika'); } else { echo osc_comment_title(); } ?></span> <?php _e('by', 'veronika') ; ?> <?php if(osc_comment_title() == '') { _e('Anonymous', 'veronika'); } else { echo osc_comment_author_name(); } ?>:</h4>
    ...
    <?php if($content_only == 0) { ?>
      <div id="side-right">
            ...
            <div class="inside">
              ...
              <?php if(osc_is_web_user_logged_in() && osc_item_user_id() == osc_logged_user_id()) { ?>
                <div id="s-tools">
                  ...
                  <a target="_blank" class="tr1 round2 sold" href="<?php echo osc_user_list_items_url() . $sold_url; ?>"><i class="fa fa-gavel"></i> <span><?php echo (osc_item_field('i_sold') == 1 ? __('Not sold', 'veronika') : __('Sold', 'veronika')); ?></span></a>
                  <a target="_blank" class="tr1 round2 reserved" href="<?php echo osc_user_list_items_url() . $reserved_url; ?>"><i class="fa fa-flag-o"></i> <span><?php echo (osc_item_field('i_sold') == 2 ? __('Unreserve', 'veronika') : __('Reserved', 'veronika')); ?></span></a>
        ...
        <!-- BANNER -->
        <?php if(osc_get_preference('theme_adsense', 'veronika_theme') == 1) { ?>
          <div class="theme-adsense adsense-item not767">
            <?php echo osc_get_preference('banner_item', 'veronika_theme'); ?>
          </div>        
        <?php } ?>
      </div>
    <?php } ?>
        ...
        <?php if($mobile <> __('No phone number', 'veronika')) { ?>  
          $('.phone-show, .phone-block').click(function(e){
            ...
            if($('.phone-block').attr('href') == '#') {
              $('.phone-block, .phone-show').attr('href', 'https://api.whatsapp.com/send?phone=62' + mobile).addClass('shown');
              $('.phone-block span').text(mobile).css('font-weight', 'bold');
              $('#side-right .btn.contact-button .bot').text(mobile);
              $('.phone-show').text("<?php _e('Click to Whatsapp', 'veronika'); ?>");
        ...
        <?php if(osc_item_show_email()) { ?>  
          $('.mail-show, .mail-block').click(function(){
            ...
            if($('.mail-block').attr('href') == '#') {
              ...
              $('.mail-show').text("<?php _e('Click to mail', 'veronika'); ?>");
