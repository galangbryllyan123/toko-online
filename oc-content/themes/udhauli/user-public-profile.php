<?php
    ...
    udhauli_add_body_class('user-public-profile');
...
?>
<div class="row" id="user-public-profile">
   <div id="item-content">
     <div class="description-header">
      <div class="user-card">
        ...
        <h2><?php _e('User Description', 'udhauli'); ?></h2>
        <?php } ?>
        <?php echo nl2br(osc_user_info()); ?>
    </div>
    <?php if( osc_count_items() > 0 ) { ?>
    <div class="similar_ads">
        <h2><?php _e('Latest listings', 'udhauli'); ?></h2>
