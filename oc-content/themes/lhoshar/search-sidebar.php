...
<div class="col-sm-4 col-md-3">
 <div id="search-sidebar">  
  ...
  <?php osc_alert_form(); ?>
  <div class="filters">
    <h3 id="search-sidebar-heading"><?php _e('Advance search', 'lhoshar') ; ?></h3><hr>
    <form action="<?php echo osc_base_url(true); ?>" method="get" class="nocsrf">
        ...
        <fieldset>
            <div class="price-slice">
                <h3><?php _e('Price', 'lhoshar') ; ?></h3>
                <span class="col-xs-6"><?php _e('Min', 'lhoshar') ; ?>.
                ...
                <span class="col-xs-6"><?php _e('Max', 'lhoshar') ; ?>.
        ...
        <?php } ?>
        <div class="actions">
            <button type="submit" class="btn btn-md"><?php _e('Apply', 'lhoshar') ; ?></button>
        </div>
    </form>
  </div> 
 </div>
    ...
    <fieldset id="refine-category-fieldset">
        <h3 id="refine-heading"><?php _e('Refine category', 'lhoshar') ; ?></h3><hr id="refine-category-hr">
        <div class="row" id="refine">
            <?php lhoshar_sidebar_category_search($category['pk_i_id']); ?>
        </div>
    </fieldset>
</div>
</div>